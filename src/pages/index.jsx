...
export default function Home() {
  return (
    <>
      <Head>
        <title>Rev — Cars that make you go wow</title>
        <meta name="description" content="Sleek car showcase — beautiful UI built with Next + Tailwind" />
      </Head>
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-black text-white">
        ...
        <main className="max-w-7xl mx-auto px-6 sm:px-8">
          ...
          <div className="mt-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center gap-3 text-sm">
              ...
              <button className="px-3 py-1 rounded-full bg-rose-600/90 hover:scale-105 transition">Electric</button>
              <button className="px-3 py-1 rounded-full bg-sky-600/90 hover:scale-105 transition">Sport</button>
              <button className="px-3 py-1 rounded-full bg-emerald-600/90 hover:scale-105 transition">Luxury</button>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <button className="px-4 py-2 bg-rose-500 rounded-md hover:brightness-110 transition">Search</button>
            </div>
          </div>
        ...
        {/* Footer */}
        <footer className="mt-12 py-8 border-t border-slate-700/40 text-center">
          <p className="text-slate-400">Made with ❤️ — Rev Showroom</p>
        </footer>
      </div>
    </>
  );
